    ...
    <form action="{{ route('calon-siswa.store') }}" method="POST">
        ...
        <div class="grid mt-6 ml-10 mr-10 place-items-center">
            ...
            <div class="w-1/2 bg-white p-7 rounded-md max-md:w-full mt-6">
                ...
                <select name="provinsi" class="mt-1 w-full py-2 focus:outline-none border-b cursor-pointer" id="provinsi" required>
                </select>
            </div>

            <div class="w-1/2 bg-white p-7 rounded-md max-md:w-full mt-6">
                <label for="kabupaten">Kabupaten / Kota</label><br>
                <select name="kabupaten" class="mt-1 w-full py-2 focus:outline-none border-b cursor-pointer" id="kabupaten" required>
                </select>
            </div>

            <div class="w-1/2 bg-white p-7 rounded-md max-md:w-full mt-6">
                <label for="kecamatan">Kecamatan</label><br>
                <select name="kecamatan" class="mt-1 w-full py-2 focus:outline-none border-b cursor-pointer" id="kecamatan" required>
                </select>
            </div>

            <div class="w-1/2 bg-white p-7 rounded-md max-md:w-full mt-6">
                <label for="desa">Desa</label><br>
                <select name="desa" class="mt-1 w-full py-2 focus:outline-none border-b cursor-pointer" id="desa" required>
                </select>
            </div>

            <div class="w-1/2 bg-white p-7 rounded-md max-md:w-full mt-6">
                <label for="kode_pos">Kode Pos</label><br>
                <select name="kode_pos" class="mt-1 w-full py-2 focus:outline-none border-b cursor-pointer" id="kode_pos">
                </select>
            </div>
